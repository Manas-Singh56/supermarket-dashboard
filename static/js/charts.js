...
function fetchInsights() {
    document.getElementById('insightsMessage').textContent = 'Analyzing data...';
    document.getElementById('insightsSpinner').style.display = 'block';
    ...
    fetch('/api/generate-insights')
        ...
        .then(data => {
            ...
            document.getElementById('insightsSpinner').style.display = 'none';
            document.getElementById('analysisLoadingOverlay').style.display = 'none';
        })
        .catch(error => {
